...
```groovy
plugins {
    id "dev.iurysouza.modulegraph" version "0.14.0" // x-release-please-version
}
```
...
```groovy
    ...
    dependencies {
        classpath "dev.iurysouza:modulegraph:0.14.0" // x-release-please-version
    }
}
...
// settings.gradle.kts
plugins {
    id("dev.iurysouza.modulegraph.settings") version "0.14.0" // x-release-please-version
}
```
